...
class LancerMainItem(models.Model):
    ...
    routing_shape_id = fields.Many2one(comodel_name="lancer.routing.shape", string="形狀", required=False, )
    routing_coating_id = fields.Many2one(comodel_name="lancer.routing.coating", string="鍍層", required=False, )
    routing_cutting_id = fields.Many2one(comodel_name="lancer.routing.cutting", string="刃口", required=False, )
    ...
    is_std_hour = fields.Boolean(string="依標工計算",  )
    item_processcost_ids = fields.One2many(comodel_name="lancer.main.item.processcost", inverse_name="main_item_id", string="內製/委外加工成本", required=False, )

    work_labor = fields.Float(string="人工成本",  required=False, )
    work_make = fields.Float(string="製造費", required=False, )
    work_efficiency = fields.Float(string="效率", required=False, )
    work_yield = fields.Float(string="良率", required=False, )
    work_plating = fields.Float(string="+電鍍", required=False, )
    work_dye_blackhead = fields.Float(string="+染黑頭", required=False, )
    work_spray_blackhead = fields.Float(string="+噴黑頭", required=False, )
    work_sum1 = fields.Float(string="合計1", required=False, )
    work_sum2 = fields.Float(string="合計2", required=False, )
    work_sum3 = fields.Float(string="合計3", required=False, )
